    ...
    <div class="box side">
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <input class="search" type="text" name="Author_Fname" size="40" value="" placeholder="Author First Name"></input>
            <input class="search" type="text" name="Author_LName" size="40" value="" placeholder="Author Last Name"></input>
            <input class="submit" type="submit" value="Search"></input>
